...
Includes extensive configuration options such as:

- choice between landing on the homepage or another page from the menu after login
- allowing or disallowing login with a password
