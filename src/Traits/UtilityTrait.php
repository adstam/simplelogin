...
trait UtilityTrait
{
     ...
     * (expires < NOW() en ouder dan invite_expiry_minutes) om tokens die
     * net zijn verlopen over te slaan.
    ...
    private function redirectWithMessage(): void
    {
        ...
        if ($returnUrl) {
            ...
            // $this->log(null, 'clean_url: ' . $cleanUrl);  // VERWIJDERD: URL te lang voor status kolom (VARCHAR 50)
